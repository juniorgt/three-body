...
(star1,) = ax[0].plot(
    [], [], label="", marker="o", color="blue", markersize=8, markeredgewidth=0
)
(star2,) = ax[0].plot(
    [], [], label="", marker="o", color="green", markersize=8, markeredgewidth=0
)
(star3,) = ax[0].plot(
    [], [], label="", marker="o", color="red", markersize=8, markeredgewidth=0
)
bar = bar_ax.bar([0], 0, color="crimson", width=0.1)


def update(frame):
    ax[0].set_title(f"Problema de los 3 cuerpos: t = {time[frame]:.3f}")
