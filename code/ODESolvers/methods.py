...
rk_methods = {
    ...
    "heun_third": np.array(
        [[0, 0, 0, 0], [a9, a9, 0, 0], [a10, 0, a10, 0], [None, a2, 0, a7]]
    ),
    "ralston_third": np.array(
        [[0, 0, 0, 0], [a6, a6, 0, 0], [a7, 0, a7, 0], [None, a13, a9, a14]]
    ),
    "ssprk3": np.array(
    ...
    "heun_euler": np.array([[0, 0, 0], [a5, a5, 0], [None, a6, a6], [None, a5, 0]]),
...
predictor = [
    ...
    np.array([23.0 / 12.0, -16.0 / 12.0, 5.0 / 12.0]),
    np.array([55.0 / 24.0, -59.0 / 24.0, 37.0 / 24.0, -9.0 / 24.0]),
    np.array(
        [
            1901.0 / 720.0,
            -2774.0 / 720.0,
...
corrector = [
    np.array([0.5, 0.5]),
    np.array([5.0 / 12.0, 2.0 / 3.0, -1.0 / 12.0]),
    np.array([9.0 / 24.0, 19.0 / 24.0, -5.0 / 24.0, 1.0 / 24.0]),
    np.array(
...
sym_methods = {
    "euler": np.array([[1], [1]]),
    "verlet": np.array([[0, 1], [0.5, 0.5]]),
    "ruth": np.array(
        [[1, -2.0 / 3.0, 2.0 / 3.0], [-1.0 / 24.0, 3.0 / 4.0, 7.0 / 24.0]]
    ),
    # leapfrog_yoshida
    ...
    "PEFRL": np.array(
        [
            [
                sym_eps2,
                sym_ksi2,
                (1.0 - 2.0 * (sym_ksi2 + sym_eps2)),
                sym_ksi2,
                sym_eps2,
            ],
            [
                (1.0 - 2.0 * sym_lam2) / 2.0,
                sym_lam2,
                sym_lam2,
                (1.0 - 2.0 * sym_lam2) / 2.0,
                0.0,
